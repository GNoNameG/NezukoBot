...
conn.sendMessage(m.chat, `*⏯ ️Descargador By ShadowBot ⏯️*\n\n*🔥Titulo:* ${title}\n*📂Tamaño del archivo:* ${filesizeF}` , 'conversation', {quoted: m, thumbnail: global.thumb, contextInfo:{externalAdReply: {title: '𝓝𝓮𝔃𝓾𝓴𝓸𝓑𝓸𝓽', body: `© ${conn.user.name}`, sourceUrl: 'enviando...', thumbnail: y}}})
